...
#define A 0
#define B 1
#define pushButton 12 // install a Pullup button with its output into Pin 2
...
int moves[] = {1400}; // Fill in this array will forward distances and turn directions in the maze (a la Lab 2)
...
void setup() {
  ...
  attachPCINT(digitalPinToPCINT(EncoderMotorLeft), indexLeftEncoderCount, CHANGE);
  ...
  attachPCINT(digitalPinToPCINT(EncoderMotorRight), indexRightEncoderCount, CHANGE);
} /////////////// end of setup ////////////////////////////////////
...
int drive(float distance)
{
  ...
  while (errorLeft > distTolerance || errorRight > distTolerance)
  {
    ...
    cmdLeft = 255 * errorLeft / countsDesired;
    cmdRight = 255 * errorRight / countsDesired;
